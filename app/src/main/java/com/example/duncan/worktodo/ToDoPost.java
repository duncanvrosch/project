...
public class ToDoPost implements Response.Listener<String>, Response.ErrorListener{
    String title;
    String name;
    String description;
    String priority;
    ...
    public ToDoPost(Context context) {
    ...
    public void postLogger(Context aContext, String logger_title, String logger_name, String logger_description, String logger_priority, String logger_timestamp){
        ...
        String json_url = "https://ide50-duncanvrosch.legacy.cs50.io:8080/todolist";
